        ...
        <div className="px-4 py-3">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-2 py-1 active:opacity-50 transition-opacity"
              title="Пригласить друзей"
              type="button"
            >
              <svg className="w-6 h-6 text-[var(--tg-theme-button-color,#3390ec)]" viewBox="0 0 512 512" fill="currentColor" style={{ transform: 'scaleY(-1)' }}>
                <path d="M215 429.4c-15.5-1.9-30.1-6.7-41.9-13.8-24.9-14.9-42.8-39.7-48.8-67.7-2.4-11.3-2.4-31.5 0-42.6 4-18.9 14.3-37.6 28.4-51.6 22-22 51.3-32.5 82.8-29.6 38.5 3.5 71.8 28.7 86.1 65 3.6 9.3 5.2 16.1 6.3 27.7 3.1 30.5-7.7 60.7-29.6 82.6-11.4 11.4-22.7 18.5-40.8 25.5-8.5 3.2-32.2 5.8-42.5 4.5z"/>
                <path d="M135 226.9c-31.4-16.9-56.9-40.7-75.2-70.1-13.9-22.4-24.7-52.5-27.4-76.5l-.7-6.3 145.5 0 145.5 0-5.4 10.7c-6.7 13.6-9.3 23.4-10 38.5-1.4 29.6 8.1 53.5 29.5 74.6 5.2 5.1 9.3 9.4 9.1 9.6-6.9 5.9-28 19-36.1 22.5l-4.5 1.9-8.4-6c-10.8-7.7-24.1-14.2-36.7-17.8-14.6-4.2-24.4-5.4-40.1-4.7-25.7 1-48.5 9.2-69.7 24.9-2.8 2.1-5.3 3.8-5.5 3.8-.2 0-4.7-2.3-9.9-5.1z"/>
                <path d="M392.1 203.8c-15.7-2.2-30.5-9.9-42.6-22.2-9.5-9.7-15.3-19.4-19.1-32.1-3.6-12.2-3.9-29.2-.6-40.7 6.9-24.3 22.5-42.1 45.5-51.6 10.2-4.3 18.8-5.6 33.1-4.9 17.5.7 31 5.9 44 16.6 12.4 10.2 22.6 26.4 26.2 41.6 2.1 9.2 2.1 25.9 0 34.9-7.3 30.7-33 54.2-64 58.5-8.8 1.3-13.4 1.2-22.5-.1zm19.5-28.2l3.4-3.4 0-16.1 0-16.1 13.3 0c7.2 0 15-.5 17.2-1 10.3-2.3 12.9-14.7 4.3-20-2.9-1.8-5.1-2-19-2l-15.8 0 0-16.3 0-16.3-2.9-3.4c-2.6-3.2-3.4-3.5-8.1-3.5-4.6 0-5.5.4-8.1 3.3l-2.9 3.2 0 16.5 0 16.5-15.5 0c-11.9 0-16.3.4-18.5 1.5-9.2 4.7-7.4 17.6 2.8 20.5 2 .5 9.9 1 17.5 1l13.7 0 0 16.1 0 16.1 3.4 3.4c2.8 2.8 4.2 3.4 7.6 3.4 3.4 0 4.8-.6 7.6-3.4z"/>
              </svg>
            </button>
          </div>
        </div>
                ...
                >
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-[var(--tg-theme-hint-color,#999999)]">
                        {formatPrice(item.price)} × {formatNumber(item.quantity)} = {formatPrice(itemTotal)}
                      </div>
                      <div className="text-sm text-[var(--tg-theme-button-color,#3390ec)] mt-1 font-medium">
                        Ваша доля: {formatPrice(userShare)}
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="mb-2">
                    ...
                    <div className={`text-sm mt-1 ${isSelected ? 'text-white/80' : 'text-[var(--tg-theme-hint-color,#999999)]'}`}>
                      ...
                      {editingItemId === item.id ? (
                        ...
                        <div>
                          ...
                          <div className="mt-2 text-sm text-white/80">
                            Вы берете: {formatNumber(selectedQuantity)} шт • {formatPrice(item.price * selectedQuantity)}
                          </div>
                        </div>
                      ) : (
                  ...
                  {!item.isCommon && (
                    <div className={`text-sm mb-2 ${isSelected ? 'text-white/80' : 'text-[var(--tg-theme-hint-color,#999999)]'}`}>
                      {totalSelected > 0 ? (
                        <>
                          Выбрано {formatNumber(totalSelected)} из {formatNumber(item.quantity)}
                          {remaining > 0 && ` • осталось ${formatNumber(remaining)}`}
